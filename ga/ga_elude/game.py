...
from ga.ga_elude import neuro_evolution
...
class Game():  
    def __init__(self):  
        ...
        self.max_enemes = 1
        # 加载飞机、敌机图片
        self.plane_image = pygame.image.load('src/hero.png').convert_alpha()
        self.enemy_image = pygame.image.load('src/bullet.png').convert_alpha()
